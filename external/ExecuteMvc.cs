//  https://lostechies.com/chadmyers/2008/06/25/hosting-an-entire-asp-net-mvc-request-for-testing-purposes/

public class TestWebMvc
{
...
public class TestASPAppHost : MarshalByRefObject
{
     ...
     {
         // This tells the CLR not to surreptitiously destroy this object -- it's a singleton
         return null;
     }
}
