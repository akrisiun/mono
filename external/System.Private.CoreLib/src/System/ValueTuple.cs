...
namespace System
{
        ...
        : IEquatable<ValueTuple>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple>, IValueTupleInternal, ITuple
    {
        ...
        int IComparable.CompareTo(object other)
        {
            ...
            {
                throw new ArgumentException(SR2.Format(SR.ArgumentException_ValueTupleIncorrectType, this.GetType().ToString()), nameof(other));
            }
        ...
        int IStructuralComparable.CompareTo(object other, IComparer comparer)
        {
            ...
            if (!(other is ValueTuple))
            {
                throw new ArgumentException(
                    SR2.Format(SR.ArgumentException_ValueTupleIncorrectType, this.GetType().ToString()), nameof(other));
            }
