...
namespace Mono.Cecil
{
    ...
    sealed class MetadataBuilder
    {
        ...
        public MetadataBuilder(ModuleDefinition module, PortablePdbWriterProvider provider)
        {
            // ANKR: TODO
        ...
        int GetStringIndexI(string @string)
        {
            if (string.IsNullOrEmpty(@string))
                return 0;

            return (int)string_heap.GetStringIndex(@string);
        }
        ...
        void AddAssemblyReferences()
        {
            ...
            for (int i = 0; i < references.Count; i++) {
                ...
                reference.token = new MetadataToken(TokenType.AssemblyRef, (uint)rid);
            }
        ...
        void AddModuleReferences()
        {
            ...
            for (int i = 0; i < references.Count; i++) {
                ...
                reference.token = new MetadataToken(
                    TokenType.ModuleRef,
                    (int)table.AddRow(GetStringIndex(reference.Name)));
            }
        }
            ...
            switch (scope.MetadataToken.TokenType) {
                ...
                case TokenType.ModuleRef:
                    ...
                    for (int i = 0; i < file_table.length; i++)
                        if (file_table.rows[i].Col2 == GetStringIndexI(scope.Name))
        ...
        MetadataToken GetTypeRefToken(TypeReference type)
        {
            ...
            return token;
#else
            // var token = default(MetadataToken);
        ...
        {
            member.token = new MetadataToken(TokenType.MemberRef, (uint)member_ref_table.AddRow(row));
        ...
        public MetadataToken GetDocumentToken(Document document)
        {
            ...
            token = new MetadataToken(TokenType.Document, document_table.AddRow(
                ...
                GetGuidIndex(ToGuidHash(document.HashAlgorithm)),
                GetBlobIndex(document.Hash),
                GetGuidIndex(ToGuidLanguage(document.Language)))));
        ...
        static readonly Guid type_text1 = new Guid("5a869d0b-6611-11d3-bd2a-0000f80849bd");
        internal static Guid ToGuid(DocumentType type)
        {
        ...
        internal static Guid ToGuidHash(DocumentHashAlgorithm hash_algo)
        {
        ...
        static class PdbGuidMapping
        {
            ...
            public static readonly Dictionary<DocumentLanguage, Guid> language_guid = new Dictionary<DocumentLanguage, Guid>();

            public static readonly Guid hash_md5 = new Guid("406ea660-64cf-4c82-b6f0-42d48172a799");
            public static readonly Guid hash_sha1 = new Guid("ff1816ec-aa5e-4d10-87f7-6f4963833460");
            public static readonly Guid hash_sha256 = new Guid("8829d00f-11b8-4213-878b-770e8597ac16");
        ...
        public static Guid ToGuidLanguage(DocumentLanguage language)
        {
            Guid guid;
        ...
        internal static Guid ToGuid(string s)
        {
            return new Guid(s);
        }
