...
{
    // using Win32Native = Mono.XHtml.IOFile.Win32FindFile;
    ...
    internal class Win32FileSystemEnumerableIterator<TSource> : Iterator<TSource>, IDisposable
    {
        ...
        private SearchResultHandlerEx<TSource> _resultHandler;
        ...
        internal Win32FileSystemEnumerableIterator(String path, String originalUserPath,
            String searchPattern, SearchOption searchOption, SearchResultHandlerEx<TSource> resultHandler)
        {
        ...
        private void CommonInit()
        {
            ...
            var data = new Win32FindFile.WIN32_FIND_DATA();
        ...
        private Win32FileSystemEnumerableIterator(String fullPath, String normalizedSearchPath,
            String searchCriteria, String userPath, SearchOption searchOption, SearchResultHandlerEx<TSource> resultHandler)
        {
            this._fullPath = fullPath;
    ...
    internal abstract class SearchResultHandlerEx<tsource>
    {
        [System.Security.SecurityCritical]
    ...
    internal class FileInfoResultHandler : SearchResultHandlerEx<FileInfo>
    {
        [System.Security.SecurityCritical]
        internal override bool IsResultIncluded(SearchResult result)
        {
