...
namespace Mono.XHtml.IOFile
{
    ...
    {
        internal static IntPtr FindFirstFile(string fileName, ref Win32FindFile.WIN32_FIND_DATA data)
        {
        ...
        internal static bool FindNextFile(IntPtr hFindFile, ref Win32FindFile.WIN32_FIND_DATA lpFindFileData)
        {
