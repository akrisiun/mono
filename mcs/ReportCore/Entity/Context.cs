...
#if  !NET40 || WEB || WPF || NETSTANDARD20
...
namespace Mono.Entity
{
    ...
    public class Context : DataContext, ISqlContext
    {
        ...
        public virtual ICollection<T> Exec<T>(SqlProc procedure) where T : class
        {
            ...
            var list = DbGetHelper.SqlGetCollection<T>(procedure);
        ...
        public XDocument ExecXml(SqlProc procedure)
        {
            ...
            XDocument doc = SqlProcConnect.ExecuteXmlReaderRetry(cmd, this);
