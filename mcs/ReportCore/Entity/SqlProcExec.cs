...
namespace System.Data.Entity
{
    ...
    public class SqlProc
    {
        ...
        public static IEnumerable<T> Exec<T>(SqlConnection conn, string sql, Action<SqlCommand> onSetup = null) where T : class
        {
            ...
            using (var command = SqlProc.CreateCommand(conn, sql, onSetup))
            {
        ...
        public static SqlCommand CreateCommand(SqlConnection conn, string commandText, Action<SqlCommand> onSetup = null)
        {
