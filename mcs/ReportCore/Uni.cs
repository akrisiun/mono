...
namespace Mono
{
    public static class Uni
    {
        ...
        public static bool AnyOemChar(string str)
        {
            ...
            //var xWin1256 = new byte[] { unchecked((byte)'ą'), unchecked((byte)'č'), unchecked((byte)'ę'), unchecked((byte)'ė') 
            //                           , unchecked((byte)'į'), unchecked((byte)'š'), unchecked((byte)'ų'), unchecked((byte)'ū'), unchecked((byte)'ž') };
            //var encoding = System.Text.Encoding.GetEncoding(1257);
            //var bad = encoding.GetString(xWin1256);

            // "Raktiniai" Ansi dekodavimo klaidu simboliai new char[] { "å", 'ü', 'ü', '½' };
