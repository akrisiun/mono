...
namespace IQToolkit.Data.Common
{
    ...
    public class BasicMapper : QueryMapper
    {
        ...
        public override ProjectionExpression GetQueryExpression(MappingEntity entity) => GetQueryExpression(entity, null);

        public virtual ProjectionExpression GetQueryExpression(MappingEntity entity, IQuery query)
        {
