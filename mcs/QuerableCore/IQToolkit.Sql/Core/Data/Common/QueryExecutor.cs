...
namespace IQToolkit.Data.Common
{
    ...
    public abstract class QueryExecutor
    {
        ...
        public abstract IEnumerable<T> ExecuteDeferred<T>(QueryCommand query, Func<FieldReader, T> fnProjector, MappingEntity entity, IQuery queryCall,  object[] paramValues);
        public abstract IEnumerable<T> Execute<T>(QueryCommand command, Func<FieldReader, T> fnProjector, MappingEntity entity, IQuery query, object[] paramValues);
