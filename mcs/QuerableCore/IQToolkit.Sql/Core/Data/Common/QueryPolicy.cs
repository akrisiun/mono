...
namespace IQToolkit.Data.Common
{
    ...
    public class QueryPolice
    {
        ...
        public virtual Expression BuildExecutionPlan(Expression query, Expression provider, Expression rootQueryable)
        { 
            var wrap = ExecutionBuilder.Build(this.translator.Linguist, this.policy, query, provider, rootQueryable);
            return wrap;
        }
    }
}