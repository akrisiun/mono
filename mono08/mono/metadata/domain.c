...
mono_init_internal (const char *filename, const char *exe_filename, const char *runtime_version)
{
	...
	g_print("DEBUG: default version %s ", DEFAULT_RUNTIME_VERSION);
#endif 
	...
	if (runtimes [0] == NULL) {
		...
		g_print("WARNING: default version %s ", DEFAULT_RUNTIME_VERSION);
	...
	g_print("Success %s\\%s.dll ", ass->basedir, ass->image);
	...
	*/
	...
	g_print("Success corlib System.Reflection");
	...
	g_print("Success corlib System.Console\n");
